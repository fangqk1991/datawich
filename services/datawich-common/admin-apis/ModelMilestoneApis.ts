export const ModelMilestoneApis = {
  ModelMilestoneListGet: {
    method: 'GET',
    route: '/api/v1/general-data/:modelKey/milestone',
  ...
  ModelMilestoneImport: {
    method: 'POST',
    route: '/api/v1/general-data/:modelKey/milestone-import',
    description: '导入模型元信息版本',
  },
  ModelMilestoneDelete: {
    method: 'DELETE',
    route: '/api/v1/general-data/:modelKey/milestone/:tagName',
    description: '删除模型元信息版本',
  },
  ModelMasterMetadataGet: {
    method: 'GET',
    route: '/api/v1/general-data/:modelKey/milestone/master/full-metadata',
    description: 'master 版本完整元信息获取',
  },
  ModelMilestoneMetadataGet: {
    method: 'GET',
    route: '/api/v1/general-data/:modelKey/milestone/:tagName/full-metadata',
